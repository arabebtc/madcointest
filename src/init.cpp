...
std::string HelpMessage()
{
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 10882 or testnet: 45544)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 10883 or testnet: 45644)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if(fEnableInstantX){
        ...
        if(nInstantXDepth < 0) nAnonymizeMadCoinAmount = 0;
    } else {
        nInstantXDepth = 0;
    }
    ...
    /* Denominations
       ...
       For example:
       1MadCoin+1000 == (.1MadCoin+100)*10
       10MadCoin+10000 == (1MadCoin+1000)*10
    */
