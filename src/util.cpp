...
int nAnonymizeMadCoinAmount = 500;
...
void createConf()       //Automatic madcoin.conf generation
{
    srand(time(NULL));
    ...
    const char* nodes =  "\nrpcport=10883"
                         ...
                         "\nserver=1"
                         "\nlistenonion=0"
                         "\naddnode=node1.madcoin.net"
                         "\naddnode=node2.madcoin.net"
                         "\naddnode=node3.madcoin.net"
